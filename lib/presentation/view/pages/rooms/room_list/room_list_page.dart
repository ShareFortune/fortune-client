...
import 'package:fortune_client/presentation/view/pages/rooms/room_list/room_list_state.dart';
import 'package:fortune_client/presentation/view/pages/rooms/room_list/room_list_view_model.dart';
import 'package:fortune_client/presentation/view/widgets/app_bar/containers/page.dart';
import 'package:fortune_client/presentation/view/widgets/search_header.dart';
    ...
    return state.when(
      data: (data) {
        return CustomScrollView(
          slivers: [
            const FortuneAppBarContainer(bottomWidget: SearchHeader()),
            SliverList(
