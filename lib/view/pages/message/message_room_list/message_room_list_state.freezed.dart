...
mixin _$MessageRoomListState {
  List<MessageRoomHost> get host => throw _privateConstructorUsedError;
...
abstract class $MessageRoomListStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<MessageRoomHost> host});
}
...
class _$_MessageRoomListState implements _MessageRoomListState {
  const _$_MessageRoomListState({required final List<MessageRoomHost> host})
      : _host = host;

  final List<MessageRoomHost> _host;
  @override
  List<MessageRoomHost> get host {
  ...
  @override
  String toString() {
    return 'MessageRoomListState(host: $host)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(_host));
...
abstract class _MessageRoomListState implements MessageRoomListState {
  const factory _MessageRoomListState(
      {required final List<MessageRoomHost> host}) = _$_MessageRoomListState;
