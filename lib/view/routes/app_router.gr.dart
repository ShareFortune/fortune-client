...
import 'package:fortune_client/view/pages/tags/select/tags_selection_page.dart'
    as _i12;
import 'package:fortune_client/view/routes/app_router.dart' as _i28;
import 'package:fortune_client/view/routes/route_guard.dart' as _i27;
...
class AppRouter extends _i25.RootStackRouter {
  ...
  final _i27.AuthGuard authGuard;

  final _i27.CheckIfMyProfileExists checkIfMyProfileExists;
...
/// generated route for
/// [_i2.EmptyRouterPage]
class CreateProfileRoute extends _i25.PageRouteInfo<void> {
  const CreateProfileRoute({List<_i25.PageRouteInfo>? children})
      : super(
          CreateProfileRoute.name,
          path: '/empty-router-page',
          initialChildren: children,
...
class EntryAddressRoute extends _i25.PageRouteInfo<EntryAddressRouteArgs> {
  EntryAddressRoute({_i26.Key? key})
      : super(
          EntryAddressRoute.name,
          path: 'enter-address',
...
/// generated route for
/// [_i9.MyPage]
class MyRoute extends _i25.PageRouteInfo<void> {
  const MyRoute()
      : super(
          MyRoute.name,
          path: 'account',
...
class TagsSelectionRoute extends _i25.PageRouteInfo<TagsSelectionRouteArgs> {
  TagsSelectionRoute({
    required List<_i29.Tag> beingSet,
    _i26.Key? key,
  }) : super(
          TagsSelectionRoute.name,
          path: 'select-tag',
...
class TagCreationRoute extends _i25.PageRouteInfo<TagCreationRouteArgs> {
  TagCreationRoute({_i26.Key? key})
      : super(
          TagCreationRoute.name,
          path: 'create-tag',
...
class EntryDescriptionRoute
    extends _i25.PageRouteInfo<EntryDescriptionRouteArgs> {
...
/// generated route for
/// [_i2.EmptyRouterPage]
class BottomSheetRouter extends _i25.PageRouteInfo<void> {
  const BottomSheetRouter({List<_i25.PageRouteInfo>? children})
      : super(
          BottomSheetRouter.name,
          path: '/empty-router-page',
          initialChildren: children,
...
/// generated route for
/// [_i2.EmptyRouterPage]
class RoomsTab extends _i25.PageRouteInfo<void> {
  const RoomsTab({List<_i25.PageRouteInfo>? children})
      : super(
          RoomsTab.name,
          path: 'rooms',
          initialChildren: children,
...
/// generated route for
/// [_i2.EmptyRouterPage]
class ParticipatingTab extends _i25.PageRouteInfo<void> {
  const ParticipatingTab({List<_i25.PageRouteInfo>? children})
      : super(
          ParticipatingTab.name,
          path: 'participating-rooms',
          initialChildren: children,
...
/// generated route for
/// [_i2.EmptyRouterPage]
class MessagesTab extends _i25.PageRouteInfo<void> {
  const MessagesTab({List<_i25.PageRouteInfo>? children})
      : super(
          MessagesTab.name,
          path: 'rooms',
          initialChildren: children,
...
/// generated route for
/// [_i15.RoomListPage]
class RoomListRoute extends _i25.PageRouteInfo<void> {
  const RoomListRoute()
      : super(
          RoomListRoute.name,
          path: '',
...
/// generated route for
/// [_i16.RoomDetailPage]
class RoomDetailRoute extends _i25.PageRouteInfo<RoomDetailRouteArgs> {
  RoomDetailRoute({
...
class ParticipatingRoomListRoute extends _i25.PageRouteInfo<void> {
...
class JoinRequestsConfirmationRoute
    extends _i25.PageRouteInfo<JoinRequestsConfirmationRouteArgs> {
...
class MessageRoomListRoute extends _i25.PageRouteInfo<void> {
...
class BasicProfileEntryRoute extends _i25.PageRouteInfo<void> {
...
class DetailedProfileEntryRoute
    extends _i25.PageRouteInfo<DetailedProfileEntryRouteArgs> {
  DetailedProfileEntryRoute({_i26.Key? key})
      : super(
          DetailedProfileEntryRoute.name,
          path: 'create-profile-detail',
...
class ProfileIconImageEntryRoute extends _i25.PageRouteInfo<void> {
...
class EntryProfileSubImageRoute extends _i25.PageRouteInfo<void> {
